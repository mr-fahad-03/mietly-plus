        ...
        <form className="mt-4 space-y-6" onSubmit={onSubmit}>
          ...
          <div className="rounded-xl border border-lime-200 bg-lime-50/40 p-4">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-2">
              <label className="block"><span className="mb-1 block text-sm">Monthly Rental Price (base)</span><input type="number" step="0.01" value={form.monthlyPrice} onChange={(e)=>setForm((p)=>({...p,monthlyPrice:e.target.value}))} required className="w-full rounded-lg border border-zinc-300 px-3 py-2"/></label>
